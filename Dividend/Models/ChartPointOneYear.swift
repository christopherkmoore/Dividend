...
class ChartPointOneYear: NSManagedObject, Decodable {
    ...
    required convenience init(from decoder: Decoder) throws {
        ...
        guard let entity = NSEntityDescription.entity(forEntityName: "ChartPointOneYear", in: CoreDataManager.shared.managedObjectContext) else {

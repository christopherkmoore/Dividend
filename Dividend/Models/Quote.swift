...
class Quote: NSManagedObject, Codable {
    ...
    required convenience init(from decoder: Decoder) throws {
        ...
        iexRealtimePrice = try quote.decodeIfPresent(Double.self, forKey: .iexRealtimePrice) ?? 0
        iexRealtimeSize = try quote.decodeIfPresent(Int16.self, forKey: .iexRealtimeSize) ?? 0
        iexLastUpdated = try quote.decodeIfPresent(Int64.self, forKey: .iexLastUpdated) ?? 0
        ...
        iexMarketPercent = try quote.decodeIfPresent(Double.self, forKey: .iexMarketPercent) ?? 0
        iexVolume = try quote.decodeIfPresent(Int32.self, forKey: .iexVolume) ?? 0
        avgTotalVolume = try quote.decode(Int64.self, forKey: .avgTotalVolume)
        iexBidPrice = try quote.decodeIfPresent(Double.self, forKey: .iexBidPrice) ?? 0
        iexBidSize = try quote.decodeIfPresent(Int16.self, forKey: .iexBidSize) ?? 0
        iexAskPrice = try quote.decodeIfPresent(Double.self, forKey: .iexAskPrice) ?? 0
        iexAskSize = try quote.decodeIfPresent(Int16.self, forKey: .iexAskSize) ?? 0

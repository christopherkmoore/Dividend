...
class StockManager {
    ...
    */
    ...
    public func lastDividend(for paymentDate: String) -> Dividend? {
        let dividend = StockManager.shared.stocks
            .compactMap { $0.dividend?.firstObject as? Dividend }
            .filter { $0.paymentDate == paymentDate }
        
        return dividend.first
    }
